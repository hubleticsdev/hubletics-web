      ...
      <div className="bg-white rounded-lg shadow mb-8">
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
              <div className="w-12 h-12 bg-[#00E599] rounded-lg flex items-center justify-center shrink-0">
            ...
            >
              <div className="w-12 h-12 bg-[#300D4F] rounded-lg flex items-center justify-center shrink-0">
                <svg className="w-7 h-7 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            >
              <div className="w-12 h-12 bg-[#24292e] rounded-lg flex items-center justify-center shrink-0">
                <svg className="w-7 h-7 text-white" fill="currentColor" viewBox="0 0 24 24">
